...
# 이미지 폴더 경로
img_folder = Path('~/bee/images_to_detect/03m').expanduser()
output_folder = Path('~/bee/output_detected/03').expanduser()
...
for img_path in sorted(img_folder.glob('*.jpg')):
    ...
    # 저장
    output_path = output_folder / f'{img_path.stem}_counted.jpg'
